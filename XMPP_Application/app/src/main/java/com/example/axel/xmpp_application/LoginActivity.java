...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            mEmailView.setError(getString(R.string.error_invalid_pseudo));
            focusView = mEmailView;
            cancel = true;
        }

        if (cancel) {
            // There was an error; don't attempt login and focus the firstzert
            ...
            Log.d(TAG, "Pseudo and password are valid !");
    ...
    private void saveCredentialsAndLogin(){
        Log.d(TAG, "save Credentials and login called !");
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        prefs.edit()
                .putString("xmpp_pseudo", mEmailView.getText().toString())
                .putString("xmpp_password", mPasswordView.getText().toString())
                .putBoolean("xmpp_logged", true)
                .commit();
